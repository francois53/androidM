...
Player = game.Class.extend({
   ...
   init: function() {
        ...
        this.sprite = new game.MovieClip([
            game.Texture.fromImage('media/nyan.png'),
            game.Texture.fromImage('media/nyan2.png')
        ]);
        ...
        this.smokeEmitter.container = game.scene.stage;
        this.smokeEmitter.textures.push('media/particle2.png');
        game.scene.emitters.push(this.smokeEmitter);
        ...
        this.flyEmitter = new game.Emitter({
		 ...
		 this.smokeEmitter.container = game.scene.stage;
        this.smokeEmitter.textures.push('media/particle3.png');
        game.scene.emitters.push(this.smokeEmitter);
		...
		this.smokeEmitter.container = game.scene.stage;
        this.smokeEmitter.textures.push('media/particle4.png');
        game.scene.emitters.push(this.smokeEmitter);
		...
		this.smokeEmitter.container = game.scene.stage;
        this.smokeEmitter.textures.push('media/particle5.png');
        game.scene.emitters.push(this.smokeEmitter);
